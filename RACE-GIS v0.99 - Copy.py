...
def create_heatmap(list_of_lat_longs,export_file):
    ...
    export_file.write('<ScreenOverlay>\n')
    export_file.write(' <name>Heatmap Key</name>\n')
    export_file.write('     <Icon>\n')
    export_file.write('         <href>\n')
    export_file.write('             X:\RACEGIS\\files\key.png\n')
    export_file.write('         </href>\n')
    export_file.write('     </Icon>\n')
    export_file.write('  <overlayXY x="0" y="1" xunits="fraction" yunits="fraction"/>\n')
    export_file.write('  <screenXY x="0" y="1" xunits="fraction" yunits="fraction"/>\n')
    export_file.write('  <rotationXY x="0.5" y="0.5" xunits="fraction" yunits="fraction"/>\n')
    export_file.write('  <size x="0" y="0" xunits="pixels" yunits="pixels"/>\n')
    export_file.write('</ScreenOverlay>\n')

    print(list_of_lat_longs)
    '''
    ...
    #Im going to sort this the old slow way so that I can get the right max/min coords
...
status_checkbox = tk.Checkbutton(extras, text="Web (wip)",variable=web_var)
