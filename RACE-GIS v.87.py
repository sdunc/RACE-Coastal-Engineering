...
years.grid(row=0, column=1,sticky=tk.W+tk.E,ipadx=2,ipady=2,padx=2,pady=2)
...
#update
update_box = ttk.Labelframe(root,text="Update")
update_box.grid(row=0,column=2,sticky=tk.W+tk.E,ipadx=2,ipady=2,padx=2,pady=2)
update_button = tk.Button(update_box,text='Update Database',command=startup_database_check)
update_button.grid(row=0,column=1,sticky=tk.W+tk.E,ipadx=2,ipady=2,padx=2,pady=2)
...
status_checkbox = tk.Checkbutton(extras, text="Active Only",variable=status_var)
status_checkbox.grid(row=2, column=1,sticky=tk.W)
status_checkbox.config(state=tk.DISABLED)  #remove once added
...
statusbar_text.set("Welcome to RACE-GIS, written by Stephen")
